...
public class TodoController {
  ...
  public String search (Model model, @ModelAttribute(name = "text") String text){
    model.addAttribute("todos", todoInterface.findByTitleStartsWith(text));
    return "todoslist";
  }
 ...
 /* @PostMapping (value = "/edittask/{id}")
  public String editTask (@ModelAttribute(name = "newTitle") String newTitleOfTask, boolean urgent, boolean done,
